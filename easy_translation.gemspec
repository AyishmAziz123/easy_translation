require_relative 'lib/easy_translation/version'

Gem::Specification.new do |spec|
  spec.name          = "easy_translation"
  spec.version       = EasyTranslation::VERSION
  spec.authors       = ["ayishm.aziz@xprolabs.com"]
  spec.email         = ["ayishm.aziz@xprolabs.com"]
  ...
  spec.metadata["allowed_push_host"] = "ayishm.aziz@xprolabs.com"
